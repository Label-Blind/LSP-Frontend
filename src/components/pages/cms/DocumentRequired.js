...
export default class DocumentRequired extends Component {
    constructor(props) {
        super(props)
    ...
    componentDidMount() {
        document.title = 'Label Service Provider | Document Required';

        const headers = {
            Accept: 'application/json',
            'Content-Type': 'application/json',
        };
        Axios.get(ApiProvider.endpoint + "/cms/document-required", {
            headers: headers
        })
            .then(res => {
                this.setState({
