...
export default class FssaiLabel extends Component {
    constructor(props) {
        super(props)
    ...
    componentDidMount() {
        document.title = 'Label Service Provider | FSSAI Labeling Regulations';

        const headers = {
            Accept: 'application/json',
            'Content-Type': 'application/json',
        };
        Axios.get(ApiProvider.endpoint + "/cms/fssai-labeling-regulations", {
            headers: headers
        })
            .then(res => {
                this.setState({
